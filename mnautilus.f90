...
!         enddo
    ...
    WRITE(*,'(4x,a19,ES13.6,1x,a6,4x)') "Tgas = ",actual_gas_temp,"[K]"
...
!       WRITE(*,'(4x,a18,x,i3)')'Results for grain',i
      WRITE(*,91)'Grain rank =',i, "Grain radius =",grain_radii(i),"[cm]","Grain temperature =",actual_dust_temp(i),"[K]"
...
92  FORMAT(2x,a18,x,F10.6,2x,a18,x,F10.6,2x,a18,x,F10.6)
