...
integer                  :: nb_grains,nb_grains_1D
real(double_precision),allocatable, dimension(:):: grain_radii,grain_temp
! real(double_precision), dimension(1:nb_grains):: grain_radii
...
! real(double_precision), dimension(1:nb_grains) :: EVAPORATION_RATES_TEMPO_H2 !< evaporation rate.Here we add to EVAPORATION_RATES_H2
...
integer                                        :: is_grain_MRN ! 1 = MRN distribution; 0 = WD distribution. (for specific case of WD see subroutine GRAIN_DIST(INDEX,DTYPE,A,DNDA))
